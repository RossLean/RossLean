...
internal static class Diagnostics
{
    ...
    {
        return Diagnostic.Create(Storage[0001], node?.GetLocation(), originalDefinition.ToDisplayString(), argumentType.ToDisplayString());
    }
    ...
    {
        return Diagnostic.Create(Storage[0002], attributeArgumentSyntaxNode?.GetLocation(), typeParameter.ToDisplayString(), argumentType.ToDisplayString());
    }
    ...
    {
        return Diagnostic.Create(Storage[0003], attributeArgumentSyntaxNode?.GetLocation(), typeParameter.ToDisplayString(), genericTypeArgument.ToDisplayString());
    }
    public static Diagnostic CreateGA0004(AttributeArgumentSyntax attributeArgumentSyntaxNode, ITypeSymbol argumentType)
    {
        return Diagnostic.Create(Storage[0004], attributeArgumentSyntaxNode?.GetLocation(), argumentType.ToDisplayString());
    }
    ...
    {
        return Diagnostic.Create(Storage[0005], attributeArgumentSyntaxNode?.GetLocation(), argumentType.ToDisplayString(), typeParameter.ToDisplayString());
    }
    public static Diagnostic CreateGA0006(AttributeArgumentSyntax attributeArgumentSyntaxNode)
    {
        return Diagnostic.Create(Storage[0006], attributeArgumentSyntaxNode?.GetLocation());
    }
    public static Diagnostic CreateGA0008(AttributeArgumentSyntax attributeArgumentSyntaxNode, ITypeSymbol argumentType)
    {
        return Diagnostic.Create(Storage[0008], attributeArgumentSyntaxNode?.GetLocation(), argumentType.ToDisplayString());
    }
    public static Diagnostic CreateGA0009(AttributeArgumentSyntax attributeArgumentSyntaxNode, ITypeSymbol argumentType)
    {
        return Diagnostic.Create(Storage[0009], attributeArgumentSyntaxNode?.GetLocation(), argumentType.ToDisplayString());
    }
    public static Diagnostic CreateGA0010(AttributeArgumentSyntax attributeArgumentSyntaxNode, ITypeSymbol argumentType)
    {
        return Diagnostic.Create(Storage[0010], attributeArgumentSyntaxNode?.GetLocation(), argumentType.ToDisplayString());
    }
    public static Diagnostic CreateGA0011(AttributeArgumentSyntax attributeArgumentSyntaxNode, ITypeSymbol argumentType)
    {
        return Diagnostic.Create(Storage[0011], attributeArgumentSyntaxNode?.GetLocation(), argumentType.ToDisplayString());
    }
    ...
    {
        return Diagnostic.Create(Storage[0013], attributeSyntaxNode?.GetLocation(), typeParameter.ToDisplayString());
    }
    public static Diagnostic CreateGA0014(AttributeSyntax attributeSyntaxNode, ISymbol symbol)
    {
        return Diagnostic.Create(Storage[0014], attributeSyntaxNode?.GetLocation(), symbol.ToDisplayString());
    }
    public static Diagnostic CreateGA0015(AttributeSyntax attributeSyntaxNode, ISymbol symbol)
    {
        return Diagnostic.Create(Storage[0015], attributeSyntaxNode?.GetLocation(), symbol.ToDisplayString());
    }
    public static Diagnostic CreateGA0016(AttributeSyntax attributeSyntaxNode, ISymbol symbol)
    {
        return Diagnostic.Create(Storage[0016], attributeSyntaxNode?.GetLocation(), symbol.ToDisplayString());
    }
    public static Diagnostic CreateGA0017(SyntaxNode node, ISymbol originalDefinition, ITypeSymbol argumentType)
    {
        return Diagnostic.Create(Storage[0017], node?.GetLocation(), originalDefinition.ToDisplayString(), argumentType.ToDisplayString());
    }
    public static Diagnostic CreateGA0019(AttributeArgumentSyntax attributeArgumentNode, string typeParameterName)
    {
        return Diagnostic.Create(Storage[0019], attributeArgumentNode?.GetLocation(), typeParameterName);
    }
    ...
    {
        return Diagnostic.Create(Storage[0020], attributeArgumentNode?.GetLocation(), string.Join(", ", recursionPath.Select(t => t.ToDisplayString())));
    }
    ...
    {
        return Diagnostic.Create(Storage[0027], nonProfileGroupTypeArgumentNode?.GetLocation());
    }
    public static Diagnostic CreateGA0028(AttributeArgumentSyntax typeProfileInheritanceAttributeArgumentNode)
    {
        return Diagnostic.Create(Storage[0028], typeProfileInheritanceAttributeArgumentNode?.GetLocation());
    }
